...
#t1=Thread(target=(x.create or x.read or x.delete),args=(key,value,timeout)) #as per the operation
#t1.start()
#t1.sleep()
#t2=Thread(target=(x.create or x.read or x. delete),args=(key,value,timeout)) #as per the operation
#t2.start()
#t2.sleep()
#and so on upto tn
